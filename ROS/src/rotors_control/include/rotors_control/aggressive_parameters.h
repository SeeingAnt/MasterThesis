...
#ifndef AGGRESSIVE_PARAMETERS_H
#define AGGRESSIVE_PARAMETERS_H
...
namespace rotors_control {
  ...
  class AggressiveControllerParameters {
	 public:
	  EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        AggressiveControllerParameters()
