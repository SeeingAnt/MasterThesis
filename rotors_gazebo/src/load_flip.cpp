...
int main(int argc, char **argv) {
  ...
  ros::Publisher Gains_pub = n.advertise<rotors_comm::GainMSG>("crazyflie2/ControlGains", 1);
...
void Control_Matrix(ifstream &Gain_file,
  ...
  string Gain1, Gain2, Gain3;
  getline(Gain_file,Gain1);
  getline(Gain_file,Gain2);
  getline(Gain_file,Gain3);

  gains_message.header.stamp = ros::Time::now();

  istringstream iss(Gain1);
  vector<string> split((istream_iterator<string>(iss)),istream_iterator<string>());

  gains_message.Gain_p[0] = atof(split[0].c_str());
  gains_message.Gain_p[1] = atof(split[1].c_str());
  gains_message.Gain_p[2] = atof(split[2].c_str());

  gains_message.Gain_d[0] = atof(split[3].c_str());
  gains_message.Gain_d[1] = atof(split[4].c_str());
  gains_message.Gain_d[2] = atof(split[5].c_str());

  istringstream iss1(Gain2);
  vector<string> split1((istream_iterator<string>(iss1)),istream_iterator<string>());

  gains_message.Gain_p[3] = atof(split1[0].c_str());
  gains_message.Gain_p[4] = atof(split1[1].c_str());
  gains_message.Gain_p[5] = atof(split1[2].c_str());

  gains_message.Gain_d[3] = atof(split1[3].c_str());
  gains_message.Gain_d[4] = atof(split1[4].c_str());
  gains_message.Gain_d[5] = atof(split1[5].c_str());


  istringstream iss2(Gain3);
  vector<string> split2((istream_iterator<string>(iss2)),istream_iterator<string>());

  gains_message.Gain_p[6] = atof(split2[0].c_str());
  gains_message.Gain_p[7] = atof(split2[1].c_str());
  gains_message.Gain_p[8] = atof(split2[2].c_str());

  gains_message.Gain_d[6] = atof(split2[3].c_str());
  gains_message.Gain_d[7] = atof(split2[4].c_str());
  gains_message.Gain_d[8] = atof(split2[5].c_str());
