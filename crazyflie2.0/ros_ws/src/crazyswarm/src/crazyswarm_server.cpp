...
#include "crazyflie_driver/Gains.h"
...
public:
    ...
    , m_initializedPosition(false)
  {
    ...
    m_subscribeCmdGains = n.subscribe(tf_prefix + "/cmd_gains", 1, &CrazyflieROS::cmdGains, this);    
    m_subscribeCmdStop = n.subscribe(m_tf_prefix + "/cmd_stop", 1, &CrazyflieROS::cmdStop, this);

    if (m_enableLogging) {
      ROS_INFO("OKOKOKOKOKOK");
      m_logFile.open("/home/antonio/prova_ws/logcf" + std::to_string(id) + ".csv");
      m_logFile << "time,";
...
public:
  ...
  void cmdGains(
    const crazyflie_driver::Gains::ConstPtr& msg)
  {
    //ROS_INFO("got a full state setpoint");
    // if (!m_isEmergency) {
      float gain1 = msg->gain1;
      float gain2 = msg->gain2;
      float gain3 = msg->gain3;
      float gain4 = msg->gain4;
      float gain5 = msg->gain5;
      float gain6 = msg->gain6;
      float gain7 = msg->gain7;
      float gain8 = msg->gain8;
      float gain9 = msg->gain9;
      float gain10 = msg->gain10;
      float gain11 = msg->gain11;
      float gain12 = msg->gain12;
...
private:
  ...
  ros::Subscriber m_subscribeCmdGains;
