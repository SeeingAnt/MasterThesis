...
%-----------------------------------------------------------
%--------Trajectory: Fifth Order Polynomial for VHC Control-
%--------Not Criterion--------------------------------------
...
%     xd0=D(1);    xdd0=DD(1) ;   xddd0=DDD(1);
%     xdf=D(2);    xddf=DD(2) ;   xdddf=DDD(2);
%     yd0=D(3);    ydd0=DD(3) ;   yddd0=DDD(3);
%     ydf=D(4);    yddf=DD(4) ;   ydddf=DDD(4);
%     zd0=D(5);    zdd0=DD(5) ;   zddd0=DDD(5);
%     zdf=D(6);    zddf=DD(6) ;   zdddf=DDD(6);
%     yawd0=D(7);  yawdd0=DD(7);  yawddd0=DDD(7);
%     yawdf=D(8);  yawddf=DD(8);  yawdddf=DDD(8);
